import {
  Laptop, Landmark, ShoppingCart, Car, Zap, Pill, Factory, RadioTower,
...
export const SECTORS = [
  { value: 'it',          label: 'IT Services',           icon: Laptop },
  { value: 'banking',     label: 'Banking & Financials',  icon: Landmark },
  { value: 'fmcg',        label: 'FMCG',                  icon: ShoppingCart },
  { value: 'auto',        label: 'Automobiles',           icon: Car },
  { value: 'energy',      label: 'Energy',                icon: Zap },
  { value: 'pharma',      label: 'Pharma & Health',       icon: Pill },
  { value: 'industrials', label: 'Industrials',           icon: Factory },
  { value: 'telecom',     label: 'Telecom',               icon: RadioTower },
  { value: 'consumer',    label: 'Consumer & Retail',     icon: ShoppingBag },
];

export const sectorMeta = (value) =>
  SECTORS.find((s) => s.value === value) || { value, label: value, icon: TrendingUp };
